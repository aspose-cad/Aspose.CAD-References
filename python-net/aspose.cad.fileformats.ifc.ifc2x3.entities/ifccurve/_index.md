---
title: IfcCurve class
second_title: Aspose.CAD for Python via .NET API References
description: 
type: docs
weight: 1350
url: /aspose.cad.fileformats.ifc.ifc2x3.entities/ifccurve/
is_root: false
---
...
**Inheritance:** [`IfcCurve`](/cad/python-net/aspose.cad.fileformats.ifc.ifc2x3.entities/ifccurve) → 
...
The IfcCurve type exposes the following members:

### Properties
| Property | Description |
| :- | :- |
| [entity_label](/cad/python-net/aspose.cad.fileformats.ifc.ifc2x3.entities/ifccurve/entity_label) | Gets the entity label. |
