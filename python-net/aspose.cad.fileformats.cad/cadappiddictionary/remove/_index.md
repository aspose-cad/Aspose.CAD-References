...
type: docs
weight: 60
url: /aspose.cad.fileformats.cad/cadappiddictionary/remove/
is_root: false
---

## remove {#str}

Removes the [`CadAppIdTableObject`](/cad/python-net/aspose.cad.fileformats.cad.cadtables/cadappidtableobject) with the specified key.
...
| :- | :- | :- |
| key | str | The [`CadAppIdTableObject`](/cad/python-net/aspose.cad.fileformats.cad.cadtables/cadappidtableobject) key to remove. |
