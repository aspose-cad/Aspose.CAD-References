---
title: write_rational_array method
second_title: Aspose.CAD for Python via .NET API References
description: 
type: docs
weight: 80
url: /aspose.cad.fileformats.tiff.filemanagement/tiffstreamwriter/write_rational_array/
is_root: false
---

## write_rational_array {#list}
...
```python
def write_rational_array(self, data):
    ...
```
