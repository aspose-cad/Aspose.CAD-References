---
title: related_port property
second_title: Aspose.CAD for Python via .NET API References
description: 
type: docs
weight: 90
url: /aspose.cad.fileformats.ifc.ifc4.entities/ifcrelconnectsports/related_port/
is_root: false
---
...
```python
@property
def related_port(self):
    ...
@related_port.setter
def related_port(self, value):
    ...
```
