...
| Name | Description |
| --- | --- |
| [CadDimAssoc](caddimassoc/)() | Initializes a new instance of the `CadDimAssoc` class. |
...
| [AssociativityFlag](../../aspose.cad.fileformats.cad.cadobjects.dimassoc/caddimassoc/associativityflag/) { get; set; } | Gets or sets the associativity flag. |
...
| [CadOsnapPointRefs](../../aspose.cad.fileformats.cad.cadobjects.dimassoc/caddimassoc/cadosnappointrefs/) { get; set; } | Gets or sets the cad osnap point refs. |
| [ChildObjects](../../aspose.cad.fileformats.cad.cadobjects/cadbaseobject/childobjects/) { get; set; } | Gets or sets the child objects. |
| [DimensionObjectId](../../aspose.cad.fileformats.cad.cadobjects.dimassoc/caddimassoc/dimensionobjectid/) { get; set; } | Gets or sets the dimension object identifier. |
