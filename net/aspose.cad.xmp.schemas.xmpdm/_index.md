...
| [AudioSampleType](./audiosampletype/) | Represents Audio sample type in [`XmpDynamicMediaPackage`](../aspose.cad.xmp.schemas.xmpdm/xmpdynamicmediapackage/). |
...
| [TimeFormat](./timeformat/) | Represents time format in [`Timecode`](../aspose.cad.xmp.schemas.xmpdm/timecode/). |
| [XmpDynamicMediaPackage](./xmpdynamicmediapackage/) | Represents XMP Dynamic Media namespace. |
## Enumeration

| Enumeration | Description |
| --- | --- |
| [ProjectType](./projecttype/) | Represents project type in [`XmpDynamicMediaPackage`](../aspose.cad.xmp.schemas.xmpdm/xmpdynamicmediapackage/). |
