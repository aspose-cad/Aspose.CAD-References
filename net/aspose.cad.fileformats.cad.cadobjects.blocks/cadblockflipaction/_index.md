---
title: Class CadBlockFlipAction
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Blocks.CadBlockFlipAction class. Class describing BLOCKFLIPACTION object
type: docs
weight: 1770
...
| Name | Description |
| --- | --- |
| [CadBlockFlipAction](cadblockflipaction/)() | Initializes a new instance of the `CadBlockFlipAction` class. |
...
| [BlockFlipActionParameterList](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblockflipaction/blockflipactionparameterlist/) { get; set; } | Gets or sets the block flip action parameter list. |
