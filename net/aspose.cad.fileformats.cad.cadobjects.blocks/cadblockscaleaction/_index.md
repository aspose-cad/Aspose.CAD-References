---
title: Class CadBlockScaleAction
...
| Name | Description |
| --- | --- |
| [CadBlockScaleAction](cadblockscaleaction/)() | Initializes a new instance of the `CadBlockScaleAction` class. |
...
| [BlockScaleActionList](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblockscaleaction/blockscaleactionlist/) { get; set; } | Gets or sets the block scale action list. |
