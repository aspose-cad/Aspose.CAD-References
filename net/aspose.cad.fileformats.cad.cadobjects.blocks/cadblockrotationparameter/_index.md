---
title: Class CadBlockRotationParameter
...
| Name | Description |
| --- | --- |
| [CadBlockRotationParameter](cadblockrotationparameter/)() | Initializes a new instance of the `CadBlockRotationParameter` class. |
...
| [Attribute280](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblock2ptparameters/attribute280/) { get; set; } | Gets or sets the attribute 280. |
| [Attribute281](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblock2ptparameters/attribute281/) { get; set; } | Gets or sets the attribute 281. |
| [Attribute305](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblockrotationparameter/attribute305/) { get; set; } | Gets or sets the attribute 305. |
| [Attribute306](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblockrotationparameter/attribute306/) { get; set; } | Gets or sets the attribute 306. |
| [Attributes](../../aspose.cad.fileformats.cad.cadobjects/cadbase/attributes/) { get; set; } | Gets or sets the attributes. |
| [Block2PtParameterList](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblock2ptparameters/block2ptparameterlist/) { get; set; } | Gets or sets the block2 pt parameter list. |
| [BlockRotationParameterList](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblockrotationparameter/blockrotationparameterlist/) { get; set; } | Gets or sets the block rotation parameter list. |
