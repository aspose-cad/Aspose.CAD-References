...
description: Trifans property. Gets or sets the input. The input element may occur any number of times. This input is a local input with the offset and set attributes
type: docs
weight: 40
url: /net/aspose.cad.fileformats.collada.fileparser.elements/trifans/input/
---
