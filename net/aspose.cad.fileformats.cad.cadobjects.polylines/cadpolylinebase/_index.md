---
title: Class CadPolylineBase
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Polylines.CadPolylineBase class. Class describing Cad POLYLINE
type: docs
weight: 3630
...
| virtual [Elevation](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/elevation/) { get; set; } | Gets or sets the elevation. |
...
| virtual [EndWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/endwidth/) { get; set; } | Gets or sets the end width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| virtual [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadbaseextrudedentity/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| virtual [MeshMVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/meshmvertexcount/) { get; set; } | Gets or sets the mesh M vertex count. |
| virtual [MeshNVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/meshnvertexcount/) { get; set; } | Gets or sets the mesh N vertex count. |
...
| virtual [StartWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/startwidth/) { get; set; } | Gets or sets the start width. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| virtual [SurfaceMDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/surfacemdensity/) { get; set; } | Gets or sets the surface M density. |
| virtual [SurfaceNDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/surfacendensity/) { get; set; } | Gets or sets the surface N density. |
| virtual [SurfaceType](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/surfacetype/) { get; set; } | Gets or sets the type of the surface. |
| virtual [Thickness](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/thickness/) { get; set; } | Gets or sets the Thickness |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/typename/) { get; } | Gets the name of the type. |
