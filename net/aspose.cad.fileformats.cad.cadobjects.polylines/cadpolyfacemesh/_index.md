---
title: Class CadPolyFaceMesh
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Polylines.CadPolyFaceMesh class. The Cad poly face mesh
type: docs
weight: 3590
...
```csharp
public class CadPolyFaceMesh : CadPolylineBase
```
...
| Name | Description |
| --- | --- |
| [CadPolyFaceMesh](cadpolyfacemesh/)() | The default constructor. |
...
| override [Elevation](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/elevation/) { get; set; } | Gets or sets the elevation. |
...
| override [EndWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/endwidth/) { get; set; } | Gets or sets the end width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
| [Flag](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/flag/) { get; set; } | Gets or sets the flag. |
...
| override [MeshMVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/meshmvertexcount/) { get; set; } | Gets or sets the mesh M vertex count. |
| override [MeshNVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/meshnvertexcount/) { get; set; } | Gets or sets the mesh N vertex count. |
...
| override [StartWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/startwidth/) { get; set; } | Gets or sets the start width. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| override [SurfaceMDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/surfacemdensity/) { get; set; } | Gets or sets the surface M density. |
| override [SurfaceNDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/surfacendensity/) { get; set; } | Gets or sets the surface N density. |
| override [SurfaceType](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/surfacetype/) { get; set; } | Gets or sets the type of the surface. |
| override [Thickness](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/thickness/) { get; set; } | Gets or sets the Thickness |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/typename/) { get; } | Gets the name of the type. |
| [VerticesFollowFlag](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/verticesfollowflag/) { get; set; } | Gets or sets vertices follow flag. |
