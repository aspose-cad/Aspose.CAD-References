---
title: Class CadWipeoutRasterImage
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Wipeout.CadWipeoutRasterImage class. The Cad Wipeout RasterImage
type: docs
weight: 3860
...
| Name | Description |
| --- | --- |
| [CadWipeoutRasterImage](cadwipeoutrasterimage/)() | Initializes a new instance of the `CadWipeoutRasterImage` class. |
...
| override [ClassVersion](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/classversion/) { get; set; } | Gets or sets the class version. |
| [ClipBoundaries](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clipboundaries/) { get; set; } | Gets or sets the clip boundaries. |
| override [ClipBoundariesCount](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/clipboundariescount/) { get; set; } | Gets or sets the clip boundaries count. |
| override [ClippingBoundaryType](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/clippingboundarytype/) { get; set; } | Gets or sets the type of the clipping boundary. |
| override [ClippingState](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/clippingstate/) { get; set; } | Gets or sets the clipping state. |
...
| override [Fade](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/fade/) { get; set; } | Gets or sets the fade. |
...
| override [ImageDefReactorReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagedefreactorreference/) { get; set; } | Gets or sets the image def reactor reference. |
| override [ImageDefReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagedefreference/) { get; set; } | Gets or sets the image def reference. |
| override [ImageDisplayProp](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagedisplayprop/) { get; set; } | Gets or sets the image display prop. |
| override [ImageSizeInPixels](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagesizeinpixels/) { get; set; } | Gets or sets the image size in pixels. |
| override [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/insertionpoint/) { get; set; } | Gets or sets the insertion point. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/typename/) { get; } | Gets the name of the type. |
| override [VectorU](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/vectoru/) { get; set; } | Gets or sets the vector u. |
| override [VectorV](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/vectorv/) { get; set; } | Gets or sets the vector v. |
...
| override [WipeoutBrightness](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/wipeoutbrightness/) { get; set; } | Gets or sets the wipeout brightness. |
| override [WipeoutContrast](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/wipeoutcontrast/) { get; set; } | Gets or sets the contrast. |
