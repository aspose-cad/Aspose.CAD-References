...
```csharp
public class GlbOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [GlbOptions](glboptions/)() | The default constructor. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/glboptions/targetformat/) { get; } |  |
