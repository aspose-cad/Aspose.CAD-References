...
```csharp
public class CgmOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [CgmOptions](cgmoptions/)() | The default constructor. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/cgmoptions/targetformat/) { get; } |  |
