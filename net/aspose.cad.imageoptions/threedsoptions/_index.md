...
```csharp
public class ThreeDSOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [ThreeDSOptions](threedsoptions/)() | The default constructor. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/threedsoptions/targetformat/) { get; } |  |
