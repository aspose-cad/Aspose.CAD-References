...
description: Aspose.CAD.ImageOptions.DicomOptions class. The DICOM file format creation options
type: docs
weight: 35530
...
| Name | Description |
| --- | --- |
| [DicomOptions](dicomoptions/)() | Initializes a new instance of the `DicomOptions` class. |
...
| [ColorType](../../aspose.cad.imageoptions/dicomoptions/colortype/) { get; set; } | Gets or sets the type of the color. |
| [Compression](../../aspose.cad.imageoptions/dicomoptions/compression/) { get; set; } | Gets or sets the compression. |
