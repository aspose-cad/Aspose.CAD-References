...
```csharp
public class StpOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [StpOptions](stpoptions/)() | The default constructor. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/stpoptions/targetformat/) { get; } |  |
