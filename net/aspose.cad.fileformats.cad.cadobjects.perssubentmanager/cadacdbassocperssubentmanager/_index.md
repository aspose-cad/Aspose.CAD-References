---
title: Class CadAcDbAssocPersSubentManager
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.PersSubentManager.CadAcDbAssocPersSubentManager class. Class describing CadAcDbAssocPersSubentManager object
type: docs
weight: 3570
...
| Name | Description |
| --- | --- |
| [CadAcDbAssocPersSubentManager](cadacdbassocperssubentmanager/)() | Initializes a new instance of the `CadAcDbAssocPersSubentManager` class. |
...
| [Attribute290](../../aspose.cad.fileformats.cad.cadobjects.perssubentmanager/cadacdbassocperssubentmanager/attribute290/) { get; set; } | Gets or sets the attribute290. |
| [Attribute90List](../../aspose.cad.fileformats.cad.cadobjects.perssubentmanager/cadacdbperssubentmanager/attribute90list/) { get; set; } | Gets or sets the attribute90 list. |
