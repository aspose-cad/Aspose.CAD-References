---
title: Class CadXrecordObject
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.AttEntities.CadXrecordObject class. Class describing Xrecord object
type: docs
weight: 1680
...
| Name | Description |
| --- | --- |
| [CadXrecordObject](cadxrecordobject/)() | Initializes a new instance of the `CadXrecordObject` class. |
...
| virtual [DefinitionTagString](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadxrecordobject/definitiontagstring/) { get; set; } | Gets or sets the definition tag string. |
...
| virtual [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/typename/) { get; } | Gets the name of the type. |
