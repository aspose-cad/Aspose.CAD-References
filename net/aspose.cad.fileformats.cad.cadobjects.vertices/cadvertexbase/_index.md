...
| Name | Description |
| --- | --- |
| [CadVertexBase](cadvertexbase/)() | Initializes a new instance of the `CadVertexBase` class. |
...
| virtual [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/bugle/) { get; set; } | Gets or sets the bugle. |
...
| virtual [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/curvefittangentdirection/) { get; set; } | Gets or sets the curve fit tangent direction. |
...
| virtual [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/endingwidth/) { get; set; } | Gets or sets the ending width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| virtual [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/flags/) { get; set; } | Gets or sets the flags. |
...
| virtual [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/locationpoint/) { get; set; } | Gets or sets the location point. |
...
| virtual [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex1/) { get; set; } | Gets or sets the mesh vertex index 1. |
| virtual [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex2/) { get; set; } | Gets or sets the mesh vertex index 2. |
| virtual [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex3/) { get; set; } | Gets or sets the mesh vertex index 3. |
| virtual [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex4/) { get; set; } | Gets or sets the mesh vertex index 4. |
...
| virtual [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/startingwidth/) { get; set; } | Gets or sets the starting width. |
...
| virtual [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/vertexid/) { get; set; } | Gets or sets the vertex id. |
