---
title: Class Cad2DVertex
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Vertices.Cad2DVertex class. The Cad 2 d vertex
type: docs
weight: 3780
...
```csharp
public class Cad2DVertex : CadVertexBase
```
...
| Name | Description |
| --- | --- |
| [Cad2DVertex](cad2dvertex/)() | The default constructor. |
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/bugle/) { get; set; } | Gets or sets the bugle. |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/curvefittangentdirection/) { get; set; } | Gets or sets the curve fit tangent direction. |
...
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/endingwidth/) { get; set; } | Gets or sets the ending width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/flags/) { get; set; } | Gets or sets the flags. |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/locationpoint/) { get; set; } | Gets or sets the location point. |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/meshvertexindex1/) { get; set; } | Gets or sets the mesh vertex index 1. |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/meshvertexindex2/) { get; set; } | Gets or sets the mesh vertex index 2. |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/meshvertexindex3/) { get; set; } | Gets or sets the mesh vertex index 3. |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/meshvertexindex4/) { get; set; } | Gets or sets the mesh vertex index 4. |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/startingwidth/) { get; set; } | Gets or sets the starting width. |
...
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad2dvertex/vertexid/) { get; set; } | Gets or sets the vertex id. |
