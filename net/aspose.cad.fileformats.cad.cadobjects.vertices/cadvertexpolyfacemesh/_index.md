---
title: Class CadVertexPolyFaceMesh
...
```csharp
public class CadVertexPolyFaceMesh : CadVertexBase
```
...
| Name | Description |
| --- | --- |
| [CadVertexPolyFaceMesh](cadvertexpolyfacemesh/)() | The default constructor. |
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/bugle/) { get; set; } | Gets or sets the bugle. |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/curvefittangentdirection/) { get; set; } | Gets or sets the curve fit tangent direction. |
...
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/endingwidth/) { get; set; } | Gets or sets the ending width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/flags/) { get; set; } | Gets or sets the flags. |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/locationpoint/) { get; set; } | Gets or sets the location point. |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex1/) { get; set; } | Gets or sets the mesh vertex index 1. |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex2/) { get; set; } | Gets or sets the mesh vertex index 2. |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex3/) { get; set; } | Gets or sets the mesh vertex index 3. |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex4/) { get; set; } | Gets or sets the mesh vertex index 4. |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/startingwidth/) { get; set; } | Gets or sets the starting width. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/typename/) { get; } | Gets the name of the type. |
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/vertexid/) { get; set; } | Gets or sets the vertex id. |
