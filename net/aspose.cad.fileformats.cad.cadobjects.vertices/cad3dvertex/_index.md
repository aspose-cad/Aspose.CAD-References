...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/curvefittangentdirection/) { get; set; } | Gets or sets the curve fit tangent direction. |
...
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/endingwidth/) { get; set; } | Gets or sets the ending width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/flags/) { get; set; } | Gets or sets the flags. |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/locationpoint/) { get; set; } | Gets or sets the location point. |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex1/) { get; set; } | Gets or sets the mesh vertex index 1. |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex2/) { get; set; } | Gets or sets the mesh vertex index 2. |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex3/) { get; set; } | Gets or sets the mesh vertex index 3. |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex4/) { get; set; } | Gets or sets the mesh vertex index 4. |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/startingwidth/) { get; set; } | Gets or sets the starting width. |
...
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/vertexid/) { get; set; } | Gets or sets the vertex id. |
