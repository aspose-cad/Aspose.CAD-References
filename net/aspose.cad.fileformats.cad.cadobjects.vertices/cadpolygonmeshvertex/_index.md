---
title: Class CadPolygonMeshVertex
...
```csharp
public class CadPolygonMeshVertex : CadVertexBase
```
...
| Name | Description |
| --- | --- |
| [CadPolygonMeshVertex](cadpolygonmeshvertex/)() | The default constructor. |
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/bugle/) { get; set; } | Gets or sets the bugle. |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/curvefittangentdirection/) { get; set; } | Gets or sets the curve fit tangent direction. |
...
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/endingwidth/) { get; set; } | Gets or sets the ending width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/flags/) { get; set; } | Gets or sets the flags. |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/locationpoint/) { get; set; } | Gets or sets the location point. |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex1/) { get; set; } | Gets or sets the mesh vertex index 1. |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex2/) { get; set; } | Gets or sets the mesh vertex index 2. |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex3/) { get; set; } | Gets or sets the mesh vertex index 3. |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex4/) { get; set; } | Gets or sets the mesh vertex index 4. |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/startingwidth/) { get; set; } | Gets or sets the starting width. |
...
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/vertexid/) { get; set; } | Gets or sets the vertex id. |
