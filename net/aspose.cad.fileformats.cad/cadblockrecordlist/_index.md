...
| Name | Description |
| --- | --- |
| [CadBlockRecordList](cadblockrecordlist/)() | Initializes a new instance of the `CadBlockRecordList` class. |

## Properties

| Name | Description |
| --- | --- |
| [CadSymbolTableGroupCodes](../../aspose.cad.fileformats.cad/cadblockrecordlist/cadsymboltablegroupcodes/) { get; set; } | Gets or sets the cad symbol table group codes. |
...
| [AddRange](../../aspose.cad.fileformats.cad/cadblockrecordlist/addrange/)(CadBlockTableObject[]) | Adds the range of the objects to container. |
| [Clear](../../aspose.cad/nongenericlist/clear/)() | Removes all items from the IList. |
| [Clone](../../aspose.cad.fileformats.cad/cadblockrecordlist/clone/)() | The clone. |
...
| [GetBlockByLayoutHandle](../../aspose.cad.fileformats.cad/cadblockrecordlist/getblockbylayouthandle/)(string) | Gets block table by layout handle |
