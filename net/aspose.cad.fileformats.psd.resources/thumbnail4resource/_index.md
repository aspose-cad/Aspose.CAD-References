...
| Name | Description |
| --- | --- |
| [Thumbnail4Resource](thumbnail4resource/)() | Initializes a new instance of the `Thumbnail4Resource` class. |
...
| override [MinimalVersion](../../aspose.cad.fileformats.psd.resources/thumbnail4resource/minimalversion/) { get; } | Gets the minimal required psd version. |
