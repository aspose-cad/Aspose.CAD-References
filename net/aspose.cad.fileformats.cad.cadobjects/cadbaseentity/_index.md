---
title: Class CadBaseEntity
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadBaseEntity class. The Cad base entity object
type: docs
weight: 2200
...
| Name | Description |
| --- | --- |
| [CadBaseEntity](cadbaseentity/)() | Initializes a new instance of the `CadBaseEntity` class. |
...
| virtual [Visible](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/visible/) { get; set; } | Gets or sets a value indicating whether this `CadBaseEntity` is visible. |
