---
title: Class CadLwPolyline
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadLwPolyline class. Class describing Cad lwPoliline
type: docs
weight: 2650
...
| Name | Description |
| --- | --- |
| [CadLwPolyline](cadlwpolyline/)() | Initializes a new instance of the `CadLwPolyline` class. |
...
| [Bugle](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/bugle/) { get; set; } | Gets or sets the bugle. |
...
| [ConstantWidth](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/constantwidth/) { get; set; } | Gets or sets the Constant Width. |
| [Coordinates](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/coordinates/) { get; set; } | Gets or sets the coordinates. |
| [Elevation](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/elevation/) { get; set; } | Gets or sets the elevation. |
...
| [EndWidth](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/endwidth/) { get; set; } | Gets or sets the end width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
| [Flag](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/flag/) { get; set; } | Gets or sets the flag. |
...
| [PointCount](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/pointcount/) { get; set; } | Gets or sets the PointCount |
...
| [StartWidth](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/startwidth/) { get; set; } | Gets or sets the start width. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| [Thickness](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/thickness/) { get; set; } | Gets or sets the Thickness |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/typename/) { get; } | Gets the name of the type. |
| [VertexIds](../../aspose.cad.fileformats.cad.cadobjects/cadlwpolyline/vertexids/) { get; set; } | Gets or sets the vertex ids. |
