...
| [ModelerFormatVersionNumber](../../aspose.cad.fileformats.cad.cadobjects/cadregion/modelerformatversionnumber/) { get; set; } | Gets or sets the modeler format version number. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadregion/typename/) { get; } | Gets the name of the type. |
