...
| Name | Description |
| --- | --- |
| [CadEllipse](cadellipse/)(Cad3DPoint, Cad3DPoint, double) | Initializes a new instance of the `CadEllipse` class. |
...
| [AxisRatio](../../aspose.cad.fileformats.cad.cadobjects/cadellipse/axisratio/) { get; set; } | Gets or sets the radius. |
...
| [CounterclockwiseFlag](../../aspose.cad.fileformats.cad.cadobjects/cadellipse/counterclockwiseflag/) { get; set; } | Gets or sets the counterclockwise flag. |
| [CounterClockwize](../../aspose.cad.fileformats.cad.cadobjects/cadarc/counterclockwize/) { get; set; } | Gets or sets the counter clockwize. |
...
| override [EndAngle](../../aspose.cad.fileformats.cad.cadobjects/cadellipse/endangle/) { get; set; } | Gets or sets the End angle. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadellipse/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| [MajorEndPoint](../../aspose.cad.fileformats.cad.cadobjects/cadellipse/majorendpoint/) { get; set; } | Gets or sets the majour end point. |
...
| [MinorEndPoint](../../aspose.cad.fileformats.cad.cadobjects/cadellipse/minorendpoint/) { get; } | Gets the minor end point. |
...
| [Radius](../../aspose.cad.fileformats.cad.cadobjects/cadcircle/radius/) { get; set; } | Gets or sets the radius. |
