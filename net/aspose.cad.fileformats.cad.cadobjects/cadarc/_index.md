...
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadArc class. Class describing Cad ARC
type: docs
weight: 2160
...
| Name | Description |
| --- | --- |
| [CadArc](cadarc/#constructor)() | Initializes a new instance of the `CadArc` class. |
| [CadArc](cadarc/#constructor_1)(Cad3DPoint, double, double, double) | Initializes a new instance of the `CadArc` class. |
...
| virtual [EndAngle](../../aspose.cad.fileformats.cad.cadobjects/cadarc/endangle/) { get; set; } | Gets or sets the End angle. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadcircle/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| virtual [StartAngle](../../aspose.cad.fileformats.cad.cadobjects/cadarc/startangle/) { get; set; } | Gets or sets Start angle. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadarc/typename/) { get; } | Gets the name of the type. |
