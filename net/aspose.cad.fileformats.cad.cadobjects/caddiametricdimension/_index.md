---
title: Class CadDiametricDimension
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadDiametricDimension class. The Cad diameter dimension. NOTE This class is an exact copy of CadRadialDimension except sublcass name
type: docs
weight: 2390
...
| Name | Description |
| --- | --- |
| [CadDiametricDimension](caddiametricdimension/)() | Initializes a new instance of the `CadDiametricDimension` class. |
...
| [LeaderLength](../../aspose.cad.fileformats.cad.cadobjects/caddiametricdimension/leaderlength/) { get; set; } | Gets or sets the leader length. |
...
| [RadiusDefinitionPoint](../../aspose.cad.fileformats.cad.cadobjects/caddiametricdimension/radiusdefinitionpoint/) { get; set; } | Gets or sets the radius definition point. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/caddiametricdimension/typename/) { get; } | Gets the name of the type. |
