...
```csharp
public class CadSpatialIndex : CadBaseObject
```
...
| Name | Description |
| --- | --- |
| [CadSpatialIndex](cadspatialindex/)() | Initializes a new instance of the `CadSpatialIndex` class. |
...
| [Timestamp](../../aspose.cad.fileformats.cad.cadobjects/cadspatialindex/timestamp/) { get; set; } | Gets or sets the timestamp. |
