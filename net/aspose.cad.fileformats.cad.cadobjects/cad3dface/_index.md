...
| Name | Description |
| --- | --- |
| [Cad3DFace](cad3dface/#constructor)() | Initializes a new instance of the `Cad3DFace` class. |
| [Cad3DFace](cad3dface/#constructor_1)(Cad3DPoint, Cad3DPoint, Cad3DPoint, Cad3DPoint) | Initializes a new instance of the `Cad3DFace` class. |
...
| [EdgesVisible](../../aspose.cad.fileformats.cad.cadobjects/cad3dface/edgesvisible/) { get; set; } | Gets or sets the visibility of edges. |
...
| [FirstCorner](../../aspose.cad.fileformats.cad.cadobjects/cad3dface/firstcorner/) { get; set; } | Gets or sets the first corner. |
| [FourthCorner](../../aspose.cad.fileformats.cad.cadobjects/cad3dface/fourthcorner/) { get; set; } | Gets or sets the forth corner. |
...
| [SecondCorner](../../aspose.cad.fileformats.cad.cadobjects/cad3dface/secondcorner/) { get; set; } | Gets or sets the second corner. |
...
| [ThirdCorner](../../aspose.cad.fileformats.cad.cadobjects/cad3dface/thirdcorner/) { get; set; } | Gets or sets the third corner. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cad3dface/typename/) { get; } | Gets the name of the type. |
