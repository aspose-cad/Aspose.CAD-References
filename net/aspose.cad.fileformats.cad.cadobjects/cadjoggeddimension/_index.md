---
title: Class CadJoggedDimension
...
```csharp
public class CadJoggedDimension : CadDimensionBase
```
...
| Name | Description |
| --- | --- |
| [CadJoggedDimension](cadjoggeddimension/)() | Initializes a new instance of the `CadJoggedDimension` class. |
...
| [JogPoint](../../aspose.cad.fileformats.cad.cadobjects/cadjoggeddimension/jogpoint/) { get; set; } | Gets or sets the jog point. |
...
| [OverrideCenter](../../aspose.cad.fileformats.cad.cadobjects/cadjoggeddimension/overridecenter/) { get; set; } | Gets or sets the override center. |
...
| [Unknown](../../aspose.cad.fileformats.cad.cadobjects/cadjoggeddimension/unknown/) { get; set; } | Gets or sets the unknown. |
