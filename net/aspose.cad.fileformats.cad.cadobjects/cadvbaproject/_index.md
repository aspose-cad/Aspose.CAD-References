---
title: Class CadVbaProject
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadVbaProject class. Class describing VBA_PROJECT object
type: docs
weight: 3190
...
| Name | Description |
| --- | --- |
| [CadVbaProject](cadvbaproject/)() | Initializes a new instance of the `CadVbaProject` class. |
...
| [BinaryObjectData](../../aspose.cad.fileformats.cad.cadobjects/cadvbaproject/binaryobjectdata/) { get; set; } | Gets or sets the binary object data. |
| [BytesNumber](../../aspose.cad.fileformats.cad.cadobjects/cadvbaproject/bytesnumber/) { get; set; } | Gets or sets the bytes number. |
