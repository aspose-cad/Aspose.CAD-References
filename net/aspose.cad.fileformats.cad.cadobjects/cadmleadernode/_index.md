...
| Name | Description |
| --- | --- |
| [CadMLeaderNode](cadmleadernode/)() | Initializes a new instance of the `CadMLeaderNode` class. |
...
| [Attribute271](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/attribute271/) { get; set; } | Gets or sets the attribute 271. |
...
| [BranchIndex](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/branchindex/) { get; set; } | Gets or sets branch index. |
| [BreakEndPoint](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/breakendpoint/) { get; set; } | Gets or sets the break end point. |
| [BreakStartPoint](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/breakstartpoint/) { get; set; } | Gets or sets the break start point. |
...
| [DogLegLength](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/dogleglength/) { get; set; } | Gets or sets dogleg length |
| [DoglegVector](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/doglegvector/) { get; set; } | Gets or sets the dogleg vector. |
...
| [HasSetDoglegVector](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/hassetdoglegvector/) { get; set; } | Gets or sets a value indicating whether this instance has set dogleg vector. |
| [HasSetLastLeaderLinePoint](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/hassetlastleaderlinepoint/) { get; set; } | Gets or sets a value indicating whether this instance has set last leader line point. |
...
| [LastLeaderLinePoint](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/lastleaderlinepoint/) { get; set; } | Gets or sets last leader line point. |
...
| [LeaderLine](../../aspose.cad.fileformats.cad.cadobjects/cadmleadernode/leaderline/) { get; set; } | Gets or sets last leader line point. |
