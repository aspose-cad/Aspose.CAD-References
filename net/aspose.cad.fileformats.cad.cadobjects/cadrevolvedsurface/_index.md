---
title: Class CadRevolvedSurface
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadRevolvedSurface class. The Cad revolved surface
type: docs
weight: 2940
...
| Name | Description |
| --- | --- |
| [CadRevolvedSurface](cadrevolvedsurface/)() | Initializes a new instance of the `CadRevolvedSurface` class. |
...
| [AxisPoint](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/axispoint/) { get; set; } | Gets or sets the axis point. |
| [AxisVector](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/axisvector/) { get; set; } | Gets or sets the axis vector. |
| [BinaryDataSize](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/binarydatasize/) { get; set; } | Gets or sets the size of the binary data. |
...
| [CloseToAxisFlag](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/closetoaxisflag/) { get; set; } | Gets or sets a value indicating whether close to axis flag. |
...
| [DraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/draftangle/) { get; set; } | Gets or sets the draft angle. |
...
| [EndDraftDistance](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/enddraftdistance/) { get; set; } | Gets or sets the end draft distance. |
...
| [IdOfRevolveEntity](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/idofrevolveentity/) { get; set; } | Gets or sets the id of revolve |
...
| [RevolveAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/revolveangle/) { get; set; } | Gets or sets the revolve angle. |
| [RevolvedSurfaceBinaryData](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/revolvedsurfacebinarydata/) { get; set; } | Gets or sets the revolved surface binary data. |
...
| [SolidFlag](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/solidflag/) { get; set; } | Gets or sets a value indicating whether solid flag. |
| [SpaceMode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/spacemode/) { get; set; } | Gets or sets the space mode. |
| [StartAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/startangle/) { get; set; } | Gets or sets the start angle. |
| [StartDraftDistance](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/startdraftdistance/) { get; set; } | Gets or sets the start draft distance. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| [TransformMatrix](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/transformmatrix/) { get; set; } | Gets or sets the transform matrix. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| [TwistAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/twistangle/) { get; set; } | Gets or sets the twist angle. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/typename/) { get; } | Gets the name of the type. |
