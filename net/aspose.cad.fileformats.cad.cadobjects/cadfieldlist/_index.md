...
| Name | Description |
| --- | --- |
| [CadFieldList](cadfieldlist/)() | Initializes a new instance of the `CadFieldList` class. |
...
| [Attribute330List](../../aspose.cad.fileformats.cad.cadobjects/cadfieldlist/attribute330list/) { get; set; } | Gets or sets the attribute330 list. |
| [Attribute90](../../aspose.cad.fileformats.cad.cadobjects/cadfieldlist/attribute90/) { get; set; } | Gets or sets the attribute90 list. |
