...
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadBody class. The Cad body
type: docs
weight: 2260
...
| [ModelerFormatNumber](../../aspose.cad.fileformats.cad.cadobjects/cadbody/modelerformatnumber/) { get; set; } | Gets or sets the modeler format number. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadbody/typename/) { get; } | Gets the name of the type. |
