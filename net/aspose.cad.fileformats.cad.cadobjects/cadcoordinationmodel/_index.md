---
title: Class CadCoordinationModel
...
| Name | Description |
| --- | --- |
| [CadCoordinationModel](cadcoordinationmodel/)() | Initializes a new instance of the `CadCoordinationModel` class. |
...
| [InsertionUnitFactor](../../aspose.cad.fileformats.cad.cadobjects/cadcoordinationmodel/insertionunitfactor/) { get; set; } | Gets or sets the insertion unit factor. |
...
| [ModelTransformCoordinates](../../aspose.cad.fileformats.cad.cadobjects/cadcoordinationmodel/modeltransformcoordinates/) { get; set; } | Gets or sets the model transform coordinates. |
...
| [SoftPointerToAcDbNavisworksModelDef](../../aspose.cad.fileformats.cad.cadobjects/cadcoordinationmodel/softpointertoacdbnavisworksmodeldef/) { get; set; } | Gets or sets the soft pointer to ac database navisworks model definition. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadcoordinationmodel/typename/) { get; } | Gets the name of the type. |
