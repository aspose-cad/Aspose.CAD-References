---
title: Class CadSolid
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadSolid class. Class describing CadSolid
type: docs
weight: 3020
...
| Name | Description |
| --- | --- |
| [CadSolid](cadsolid/)() | Initializes a new instance of the `CadSolid` class. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadsolid/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
| [FirstCorner](../../aspose.cad.fileformats.cad.cadobjects/cadsolid/firstcorner/) { get; set; } | Gets or sets the first corner. |
| [FourthCorner](../../aspose.cad.fileformats.cad.cadobjects/cadsolid/fourthcorner/) { get; set; } | Gets or sets the fourth corner. |
...
| [SecondCorner](../../aspose.cad.fileformats.cad.cadobjects/cadsolid/secondcorner/) { get; set; } | Gets or sets the second corner. |
...
| [Thickness](../../aspose.cad.fileformats.cad.cadobjects/cadsolid/thickness/) { get; set; } | Gets or sets the thickness. |
| [ThirdCorner](../../aspose.cad.fileformats.cad.cadobjects/cadsolid/thirdcorner/) { get; set; } | Gets or sets the third corner. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadsolid/typename/) { get; } | Gets the name of the type. |
