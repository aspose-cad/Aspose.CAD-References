---
title: Class CadTableGeometry
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadTableGeometry class. Class describing TABLEGEOMETRY object
type: docs
weight: 3110
...
| Name | Description |
| --- | --- |
| [CadTableGeometry](cadtablegeometry/)() | Initializes a new instance of the `CadTableGeometry` class. |
...
| [TableGeometryParams](../../aspose.cad.fileformats.cad.cadobjects/cadtablegeometry/tablegeometryparams/) { get; set; } | Gets or sets the table geometry parameters. |
