...
| Name | Description |
| --- | --- |
| [CadSection](cadsection/)() | Initializes a new instance of the `CadSection` class. |
...
| [BackLineVertices](../../aspose.cad.fileformats.cad.cadobjects/cadsection/backlinevertices/) { get; set; } | Gets or sets the back line vertices. |
| [BackLineVerticesNumber](../../aspose.cad.fileformats.cad.cadobjects/cadsection/backlineverticesnumber/) { get; set; } | Gets or sets the back line vertices number. |
...
| [GeometrySettingsObjectHandle](../../aspose.cad.fileformats.cad.cadobjects/cadsection/geometrysettingsobjecthandle/) { get; set; } | Gets or sets the geometry settings object handle. |
...
| [IndicatorColor411](../../aspose.cad.fileformats.cad.cadobjects/cadsection/indicatorcolor411/) { get; set; } | Gets or sets the indicator color411. |
| [IndicatorColor63](../../aspose.cad.fileformats.cad.cadobjects/cadsection/indicatorcolor63/) { get; set; } | Gets or sets the indicator color63. |
| [IndicatorTransparency](../../aspose.cad.fileformats.cad.cadobjects/cadsection/indicatortransparency/) { get; set; } | Gets or sets the indicator transparency. |
...
| [Name](../../aspose.cad.fileformats.cad.cadobjects/cadsection/name/) { get; set; } | Gets or sets the name. |
...
| [SectionFlags](../../aspose.cad.fileformats.cad.cadobjects/cadsection/sectionflags/) { get; set; } | Gets or sets the section flags. |
| [SectionState](../../aspose.cad.fileformats.cad.cadobjects/cadsection/sectionstate/) { get; set; } | Gets or sets the state of the section. |
...
| [TopHeight](../../aspose.cad.fileformats.cad.cadobjects/cadsection/topheight/) { get; set; } | Gets or sets the height of the top. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadsection/typename/) { get; } | Gets the name of the type. |
| [VerticalDirection](../../aspose.cad.fileformats.cad.cadobjects/cadsection/verticaldirection/) { get; set; } | Gets or sets the vertical direction. |
| [Vertices](../../aspose.cad.fileformats.cad.cadobjects/cadsection/vertices/) { get; set; } | Gets or sets the vertices. |
| [VerticesNumber](../../aspose.cad.fileformats.cad.cadobjects/cadsection/verticesnumber/) { get; set; } | Gets or sets the vertices number. |
