---
title: Class CadAngularDimension
...
| Name | Description |
| --- | --- |
| [CadAngularDimension](cadangulardimension/)() | Initializes a new instance of the `CadAngularDimension` class. |
...
| [LeftBottomPoint](../../aspose.cad.fileformats.cad.cadobjects/cadangulardimension/leftbottompoint/) { get; set; } | Gets left bottom point |
...
| [RightBottomPoint](../../aspose.cad.fileformats.cad.cadobjects/cadangulardimension/rightbottompoint/) { get; set; } | Gets right bottom point |
| [RightTopPoint](../../aspose.cad.fileformats.cad.cadobjects/cadangulardimension/righttoppoint/) { get; set; } | Gets right top point |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadangulardimension/typename/) { get; } | Gets the name of the type. |
