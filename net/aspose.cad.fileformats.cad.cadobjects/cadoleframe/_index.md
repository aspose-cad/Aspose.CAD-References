---
title: Class CadOleFrame
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadOleFrame class. The Cad OleFrame
type: docs
weight: 2830
...
| Name | Description |
| --- | --- |
| [CadOleFrame](cadoleframe/)() | Initializes a new instance of the `CadOleFrame` class. |
...
| [BinaryData](../../aspose.cad.fileformats.cad.cadobjects/cadoleframe/binarydata/) { get; set; } | Gets or sets the binary data. |
| [BinaryDataLength](../../aspose.cad.fileformats.cad.cadobjects/cadoleframe/binarydatalength/) { get; set; } | Gets or sets the binary data length. |
...
| [OleDataEnd](../../aspose.cad.fileformats.cad.cadobjects/cadoleframe/oledataend/) { get; set; } | Gets or sets the OLE data end. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadoleframe/typename/) { get; } | Gets the name of the type. |
| [VersionNumber](../../aspose.cad.fileformats.cad.cadobjects/cadoleframe/versionnumber/) { get; set; } | Gets or sets the version number. |
