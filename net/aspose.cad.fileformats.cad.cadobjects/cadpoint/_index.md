---
title: Class CadPoint
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadPoint class. Class describing Cad Point
type: docs
weight: 2870
...
| Name | Description |
| --- | --- |
| [CadPoint](cadpoint/)() | Initializes a new instance of the `CadPoint` class. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadpoint/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| [PointLocation](../../aspose.cad.fileformats.cad.cadobjects/cadpoint/pointlocation/) { get; set; } | Gets or sets the point location. |
...
| [StartAngle](../../aspose.cad.fileformats.cad.cadobjects/cadpoint/startangle/) { get; set; } | Gets or sets angle XAxis. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadpoint/typename/) { get; } | Gets the name of the type. |
