...
```csharp
public class CadXLine : CadBaseInfinityEntity
```
...
| Name | Description |
| --- | --- |
| [CadXLine](cadxline/)(Cad3DPoint, Cad3DPoint) | Initializes a new instance of the `CadXLine` class. |
...
| override [FirstPoint](../../aspose.cad.fileformats.cad.cadobjects/cadxline/firstpoint/) { get; set; } | Gets or sets the first point . |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadxline/typename/) { get; } | Gets the name of the type. |
| override [UnitDirectionVector](../../aspose.cad.fileformats.cad.cadobjects/cadxline/unitdirectionvector/) { get; set; } | Gets or sets the unit direction vector. |
