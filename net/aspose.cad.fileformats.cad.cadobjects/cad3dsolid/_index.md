...
| [HandleToHistoryObject](../../aspose.cad.fileformats.cad.cadobjects/cad3dsolid/handletohistoryobject/) { get; set; } | Gets or sets the handle to history object. |
...
| [ModelerFormatVersion](../../aspose.cad.fileformats.cad.cadobjects/cad3dsolid/modelerformatversion/) { get; set; } | Gets or sets the Modeler format version number (currently = 1) |
