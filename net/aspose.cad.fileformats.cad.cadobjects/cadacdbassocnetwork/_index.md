---
title: Class CadAcDbAssocNetwork
...
| Name | Description |
| --- | --- |
| [CadAcDbAssocNetwork](cadacdbassocnetwork/)() | Initializes a new instance of the `CadAcDbAssocNetwork` class. |

## Properties

| Name | Description |
| --- | --- |
| [AccosActionsList](../../aspose.cad.fileformats.cad.cadobjects/cadacdbassocnetwork/accosactionslist/) { get; set; } | Gets or sets the accos actions list. |
| [AccosNetworkList](../../aspose.cad.fileformats.cad.cadobjects/cadacdbassocnetwork/accosnetworklist/) { get; set; } | Gets or sets the accos network list. |
