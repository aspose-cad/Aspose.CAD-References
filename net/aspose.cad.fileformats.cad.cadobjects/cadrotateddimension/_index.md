---
title: Class CadRotatedDimension
...
| Name | Description |
| --- | --- |
| [CadRotatedDimension](cadrotateddimension/)() | Initializes a new instance of the `CadRotatedDimension` class. |
...
| override [DefinitionPoint1](../../aspose.cad.fileformats.cad.cadobjects/cadrotateddimension/definitionpoint1/) { get; set; } | Gets or sets the definition point1. |
| override [DefinitionPoint2](../../aspose.cad.fileformats.cad.cadobjects/cadrotateddimension/definitionpoint2/) { get; set; } | Gets or sets the definition point2. |
...
| [ExtensionLineAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrotateddimension/extensionlineangle/) { get; set; } | Gets or sets the extension line angle. |
...
| override [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects/cadrotateddimension/insertionpoint/) { get; set; } | Gets or sets the insertion point. |
...
| [RotationAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrotateddimension/rotationangle/) { get; set; } | Gets or sets the rotation angle. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadrotateddimension/typename/) { get; } | Gets the name of the type. |
