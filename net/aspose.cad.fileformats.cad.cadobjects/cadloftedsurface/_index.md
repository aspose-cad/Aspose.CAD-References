---
title: Class CadLoftedSurface
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadLoftedSurface class. The Cad lofted surface
type: docs
weight: 2640
...
| Name | Description |
| --- | --- |
| [CadLoftedSurface](cadloftedsurface/)() | Initializes a new instance of the `CadLoftedSurface` class. |

## Properties

| Name | Description |
| --- | --- |
| [AlignDirectionFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/aligndirectionflag/) { get; set; } | Gets or sets a value indicating whether align direction flag. |
...
| [ArcLengthParamFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/arclengthparamflag/) { get; set; } | Gets or sets a value indicating whether arc length parameter flag. |
...
| [ClosedSurfaceFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/closedsurfaceflag/) { get; set; } | Gets or sets a value indicating whether closed surface flag. |
...
| [CountIsolinesU](../../aspose.cad.fileformats.cad.cadobjects/cadplanesurface/countisolinesu/) { get; set; } | Gets or sets the count isolines u. |
| [CountIsolinesV](../../aspose.cad.fileformats.cad.cadobjects/cadplanesurface/countisolinesv/) { get; set; } | Gets or sets the count isolines v. |
...
| [EndDraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/enddraftangle/) { get; set; } | Gets or sets the end draft angle. |
| [EndDraftMagnitude](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/enddraftmagnitude/) { get; set; } | Gets or sets the end draft magnitude. |
...
| [ModelerFormatVersion](../../aspose.cad.fileformats.cad.cadobjects/cadplanesurface/modelerformatversion/) { get; set; } | Gets or sets the modeler format version. |
...
| [PlaneNormalType](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/planenormaltype/) { get; set; } | Gets or sets the plane normal type. |
...
| [RuledSurfaceFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/ruledsurfaceflag/) { get; set; } | Gets or sets a value indicating whether ruled surface flag. |
| [ShadowMode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/shadowmode/) { get; set; } | Gets or sets the shadow mode. |
| [SimpleSurfaceFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/simplesurfaceflag/) { get; set; } | Gets or sets a value indicating whether simple surface flag. |
| [SoftOwner](../../aspose.cad.fileformats.cad.cadobjects/cadbaseowned/softowner/) { get; set; } | Gets or sets the soft owner. |
| [SolidFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/solidflag/) { get; set; } | Gets or sets a value indicating whether solid flag. |
| [SpaceMode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/spacemode/) { get; set; } | Gets or sets the space mode. |
| [StartDraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/startdraftangle/) { get; set; } | Gets or sets the start draft angle. |
| [StartDraftMagnitude](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/startdraftmagnitude/) { get; set; } | Gets or sets the start draft magnitude. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| [TransformMatrix](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/transformmatrix/) { get; set; } | Gets or sets the transform matrix. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| [TwistFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/twistflag/) { get; set; } | Gets or sets a value indicating whether twist flag. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/typename/) { get; } | Gets the name of the type. |
| [VirtualGuideFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/virtualguideflag/) { get; set; } | Gets or sets a value indicating whether virtual guide flag. |
...
| [InitProprietaryData](../../aspose.cad.fileformats.cad.cadobjects/cadobjectwithacisdata/initproprietarydata/)(CadEntityAttribute, string) | Initializes the proprietary data. |
