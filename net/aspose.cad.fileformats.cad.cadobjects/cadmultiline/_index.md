...
| Name | Description |
| --- | --- |
| [CadMultiLine](cadmultiline/)() | Initializes a new instance of the `CadMultiLine` class. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
| [Flags](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/flags/) { get; set; } | Gets or sets flags |
...
| [Justification](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/justification/) { get; set; } | Gets or sets the justification: 0 = Top; 1 = Zero; 2 = Bottom |
...
| [NumberOfStyleElements](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/numberofstyleelements/) { get; set; } | Gets or sets the number of style elements. |
| [NumberOfVertices](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/numberofvertices/) { get; set; } | Gets or sets the number of vertices. |
...
| [OpenClosed](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/openclosed/) { get; set; } | Gets or sets the openClosed: 1 = open; 3 = Closed |
...
| [Scale](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/scale/) { get; set; } | Gets or sets scale |
...
| [StartPoint](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/startpoint/) { get; set; } | Gets the start point. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| [StyleName](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/stylename/) { get; set; } | Gets or sets the style name. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/typename/) { get; } | Gets the name of the type. |
| [VectorBlocks](../../aspose.cad.fileformats.cad.cadobjects/cadmultiline/vectorblocks/) { get; set; } | Gets or sets the vector blocks. |
