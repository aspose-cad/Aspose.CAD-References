---
title: Class CadDwfUnderlay
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadDwfUnderlay class. Class describing CadDwfUnderlay
type: docs
weight: 2440
...
| Name | Description |
| --- | --- |
| [AcDbUnderlayDefinitionObjectId](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/acdbunderlaydefinitionobjectid/) { get; set; } | Gets or sets the ac database underlay definition object identifier. |
...
| [Contrast](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/contrast/) { get; set; } | Gets or sets the contrast. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
| [Fade](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/fade/) { get; set; } | Gets or sets the fade. |
| [Flags](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/flags/) { get; set; } | Gets or sets the flags. |
...
| [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/insertionpoint/) { get; set; } | Gets or sets the insertion point . |
...
| [Points2d](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/points2d/) { get; set; } | Gets or sets the points2d. |
...
| [RotationAngle](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/rotationangle/) { get; set; } | Gets or sets the rotation angle. |
| [ScaleX](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/scalex/) { get; set; } | Gets or sets the scale x. |
| [ScaleY](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/scaley/) { get; set; } | Gets or sets the scale y. |
| [ScaleZ](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/scalez/) { get; set; } | Gets or sets the scale z. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/caddwfunderlay/typename/) { get; } | Gets the name of the type. |
| [UnderlayName](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/underlayname/) { get; set; } | Gets or sets the name of the underlay. |
| [UnderlayPath](../../aspose.cad.fileformats.cad.cadobjects/cadunderlay/underlaypath/) { get; set; } | Gets or sets the underlay path. |
