---
title: Class CadTolerance
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadTolerance class. The Cad tolerance
type: docs
weight: 3150
...
| Name | Description |
| --- | --- |
| [CadTolerance](cadtolerance/)() | Initializes a new instance of the `CadTolerance` class. |
...
| [DimensionStyleName](../../aspose.cad.fileformats.cad.cadobjects/cadtolerance/dimensionstylename/) { get; set; } | Gets or sets the dimension style name. |
| [DirectionVector](../../aspose.cad.fileformats.cad.cadobjects/cadtolerance/directionvector/) { get; set; } | Gets or sets the direction vector. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadtolerance/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects/cadtolerance/insertionpoint/) { get; set; } | Gets or sets the insertion point. |
...
| [ToleranceString](../../aspose.cad.fileformats.cad.cadobjects/cadtolerance/tolerancestring/) { get; set; } | Gets or sets the tolerance string. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadtolerance/typename/) { get; } | Gets the name of the type. |
