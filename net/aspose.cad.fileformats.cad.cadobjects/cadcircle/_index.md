...
| Name | Description |
| --- | --- |
| [CadCircle](cadcircle/#constructor)() | Initializes a new instance of the `CadCircle` class. |
| [CadCircle](cadcircle/#constructor_1)(Cad3DPoint, double) | Initializes a new instance of the `CadCircle` class. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadcircle/typename/) { get; } | Gets the name of the type. |
