...
description: Aspose.CAD.FileFormats.Tiff.TiffTagTypes.TiffByteType class. The tiff byte type
type: docs
weight: 34870
...
| override [ElementSize](../../aspose.cad.fileformats.tiff.tifftagtypes/tiffbytetype/elementsize/) { get; } | Gets the element size in bytes. |
...
| override [TagType](../../aspose.cad.fileformats.tiff.tifftagtypes/tiffbytetype/tagtype/) { get; } | Gets the tag type. |
| override [Value](../../aspose.cad.fileformats.tiff.tifftagtypes/tiffbytetype/value/) { get; set; } | Gets or sets the value this data type contains. |
| [Values](../../aspose.cad.fileformats.tiff.tifftagtypes/tiffbytetype/values/) { get; set; } | Gets or sets the values. |
| override [ValuesContainer](../../aspose.cad.fileformats.tiff.tifftagtypes/tiffbytetype/valuescontainer/) { get; } | Gets the values container. |
...
| override [WriteAdditionalData](../../aspose.cad.fileformats.tiff.tifftagtypes/tiffbytetype/writeadditionaldata/)(TiffStreamWriter) | Writes the additional tag data. |
