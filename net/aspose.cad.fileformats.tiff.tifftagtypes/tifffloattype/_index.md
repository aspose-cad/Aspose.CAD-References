...
| Name | Description |
| --- | --- |
| [TiffFloatType](tifffloattype/#constructor)(TiffTags) | Initializes a new instance of the `TiffFloatType` class. |
| [TiffFloatType](tifffloattype/#constructor_1)(ushort) | Initializes a new instance of the `TiffFloatType` class. |
